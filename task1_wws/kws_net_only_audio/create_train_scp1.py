...
if __name__ == '__main__':
    ...
    positive_train = [os.path.join(data_root, 'positive/audio/train/middle/*_1_*_*.wav')]
    negative_train = [os.path.join(data_root, 'negative/audio/train/middle/*_1_*_*.wav')]
    for snr in SNR_list:
    ...
    positive_dev = [os.path.join(data_root, 'positive/audio/dev/*/*_1_*_*.wav')]
    negative_dev = [os.path.join(data_root, 'negative/audio/dev/*/*_1_*_*.wav')]
    positive_dev_middle = [os.path.join(data_root, 'positive/audio/dev/middle/*_1_*_*.wav')]
    positive_dev_far = [os.path.join(data_root, 'positive/audio/dev/far/*_1_*_*.wav')]
