...
def test(args):
    ...
    # file path
    file_positive_path = 'scp_dir/positive_dev.scp'
    file_negative_path = 'scp_dir/negative_dev.scp'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_model", default='./video_model/kws_video_16.model', type=str,
                        help="load video trained model")
